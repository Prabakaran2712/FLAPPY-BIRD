...
def draw_floor():
    ...
    screen.blit(floor_surface, (floor_x_pos+276, 500))
def create_pipe():
...
def score_display(game_state):
    ...
    if game_state=='game_over':
      ...
      high_score_rect = score_surface.get_rect(center=(125, 150))
...
pygame.init()
screen=pygame.display.set_mode((276,600))
...
game_over_rect=game_over_surface.get_rect(center=(140,350))
flap_sound=pygame.mixer.Sound('audio/wing.ogg')
hit_sound=pygame.mixer.Sound('audio/hit.ogg')
death_sound=pygame.mixer.Sound('audio/die.ogg')
